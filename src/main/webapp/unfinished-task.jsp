...
<head>
    ...
    $(document).ready(function(){ 
 	...
 	function query() {
    	$.ajax( {  
            url:"taskController/queryUnfinshTask",// 跳转到 action  
            type:'post',  
            cache:false,  
            dataType:'json',  
            success:function(data) {
       		 ...
       		 var taskCreateTime=item.taskCreateTime;
       		 
       		 $("#tbody").append("<tr>"+"<td><input type='checkbox' name='ck_order' value='" + taskID + "'></td>"+"<td>"+taskID+"</td>"+"<td>"+taskName+"</td>"+"<td>"+taskCreateTime+"</td>"
       				 +"<td><a href='taskController/handletask?taskId="+taskID+"'>审批处理</a></td>"+"</tr>")
           	 });
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">待办理任务管理</div>
                            </div>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" id="handletask" class="am-btn am-btn-default am-btn-success">批量同意任务</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
