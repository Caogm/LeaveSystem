...
<head>
    ...
    $(document).ready(function(){ 
 	...
 	function query() {
    	$.ajax( {  
            url:"taskController/queryfinshedtask",// 跳转到 action  
            type:'post',  
            cache:false,  
            dataType:'json',  
            success:function(data) {
       		 ...
       		 var cretetime=item.cretetime;
      		 var endtime=item.endtime;
       		 
       		 $("#tbody").append("<tr>"+"<td>"+id+"</td>"+"<td>"+name+"</td>"+"<td>"+ProcessInstanceId+"</td>"
       				+"<td>"+cretetime+"</td>"+"<td>"+endtime+"</td>"+"<td><a href='taskController/querytaskdetail?id="+id+"'>查看详情</a></td>"+"</tr>")
           	 });
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">已处理任务</div>
                            </div>
