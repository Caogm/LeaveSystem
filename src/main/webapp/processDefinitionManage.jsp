...
<head>
    ...
    $(document).ready(function(){  
    	searchprocessdefinition()//打开页面即执行函数
   }); 

    
    function searchprocessdefinition(){//使用关键词进行模糊搜索
    	$.ajax( {  
            url:"processDefinitionController/searchProcessDefinition",// 跳转到 action  
            data:{  
            	pdname:$('#pdname').val()
            },  
            type:'post',  
            ...
            success:function(data) {
       		 ...
       		 $.each(vendorJson,function (index , item ) {
		       		...
		       		var dresname=item.dresname;
		       		var did=item.did;
       		 $("#tbody").append("<tr>"+"<td>"+id+"</td>"+"<td>"+name+"</td>"+"<td>"+key+"</td>"
       				 +"<td>"+version+"</td>"+"<td>"+resname+"</td>"+"<td>"+dresname+"</td>"+"<td>"+did+"</td>"
       				+"<td><a href='leaveController/setsessionkey?key="+key+"'>应用此流程</a></td>"+"</tr>")//
           	 });
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">流程定义管理</div>
                            </div>
                            <div class="widget-body  am-fr">

                                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                        <input type="text" class="am-form-field "  id="pdname" name="pdname">
                                        <span class="am-input-group-btn">
                                            <button type="submit" class="am-btn  am-btn-default am-btn-success tpl-table-list-field am-icon-search" onclick="searchprocessdefinition()"></button>
                                        </span>
                                    </div>
                                </div>
