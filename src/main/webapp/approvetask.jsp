                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">编辑审批单</div>
                            </div>
                            <!-- 表单提交地址 -->
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="submit" id="agree" class="am-btn am-btn-default am-btn-secondary">同意</button>
                                                <button type="submit" id="disagree" onclick="$('#statuscode').val('0')" class="am-btn am-btn-default am-btn-secondary">驳回</button>
                                            </div><br/><br/>
                                            	审批意见
                                            <textarea id="opinion" class="am-u-md-12"  name="opinion"></textarea>
                                           
                                        </div>
                                        <input type="hidden" id="statuscode" name="statuscode" value="1">
                                    </div>
                                </div>
                                
                                <div class="am-u-sm-12">
                                <div class="am-form-group">
                                    <select name="leavetype" data-am-selected="{btnSize: 'sm'}" value="${leave.leavetype}">
                                    ...
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                        <tbody>
											...
											<tr style="display:none">
												...
												<td><input type="text" name="ProcessInstanceId" value="${ProcessInstanceId}" /></td>
											</tr>
											<tr style="display:none">
												<td>leaveId</td>
												<td><input type="text" name="leaveId" value="${leave.id}" /></td>
											</tr>
											<tr style="display:none">
												<td>审批用户名</td>
                                            ...
                                            <tr>
												<td>工号</td>
												<td><input type="text" name="uid" value="${leave.uid}" readonly/></td>
											</tr>
											<tr>
												<td>姓名</td>
												<td><input type="text" name="uname" value="${leave.uname}" readonly/></td>
											</tr>
											<tr>
												<td>岗位</td>
												<td><input type="text" name="upost" value="${leave.upost}" readonly/></td>
											</tr>
											<tr>
												<td>部门</td>
												<td><input type="text" name="usys" value="${leave.usys}" readonly/></td>
											</tr>
											
											<tr>
												<td>离开时间</td>
												<td><input type="text" name="leavetime" value="${leave.leavetime}" readonly/></td>
											</tr>
											<tr>
												<td>返回时间</td>
												<td><input type="text" name="backtime" value="${leave.backtime}" readonly/></td>
											</tr>
											<tr>
												<td>请假天数</td>
												<td><input type="text" name="leavedays" value="${leave.leavedays}" readonly/></td>
										
											</tr>
											<tr>
												<td>请假理由</td>
												<td>
												<textarea class="am-u-md-12"  name="reason" readonly="readonly">${leave.reason} </textarea>
												</td>
											</tr>
