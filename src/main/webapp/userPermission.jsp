...
<head>
    ...
    function submitUserPermission(){
    	$.ajax( {  
            url:"MembershipController/setMembership",// 跳转到 action  
            data:{  
            	actuserId:$('#actuserId').val(),
            	post:$('#post').val()
            },  
            type:'post',  
            cache:false,  
    ...
    //用户权限查询
    function queryUserPermission(){
    	$.ajax( {  
            url:"MembershipController/queryMembership",// 跳转到 action  
            data:{  
            	query:"emp"
            }, 
            type:'post',  
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">用户权限管理</div>
                            </div>
                            <div class="widget-body  am-fr">
                                ...
                                <div id="hideandshow" class="am-u-sm-12 am-u-md-12 am-u-lg-3 ">
                                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    	请输入用户权限名
                                        <input type="text" class="am-form-field "  id="actuserId" name="actuserId">
                                    </div>
                                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    	请输入用户组别名
                                        <input type="text" class="am-form-field "  id="post" name="post">
                                    </div>
                                    <div class="am-input-group-btn">
                                            <button type="submit" class="am-btn  am-btn-default am-btn-success" onclick="submitUserPermission()">提交</button>
                                    </div>
                                </div>
                        ...
                        <div class="widget am-cf">
                            ...
                            <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="GroupTable" >
                                        <thead>
                                            <tr id="tr">
