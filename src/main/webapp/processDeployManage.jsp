    	...
    	$.ajax( {  
            ...
            success:function(data) {
       		 ...
       		 $.each(vendorJson,function (index , item ) {
       			var username=item.id;//流程ID
	       		var processname=item.name;//流程名称
	       		var date=item.date;//流程部署时间

       		 $("#tbody").append("<tr>"+"<td><input type='checkbox' name='ck_order' value='" + username + "'></td>"+"<td>"+username+"</td>"
       				 +"<td>"+processname+"<td>"+date+"</td>"+"</td></tr>")      				
       		 });
       		/* alert("查询成功！");  */
             },  
             error : function() {  
    ...
    function deletedeploy(){
  		$("#delete").click(function(){
  			...
  			if(confirm("确定要删除所选项目？")){
  				...
  				$.ajax({
  					type:"POST",
  					url:"deployController/delDeploy",
  					data:{
                            ...
                            <form action="deployController/addDeploy" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                           <div class="am-btn-group am-btn-group-xs">
                                                <button type="submit" id="add" class="am-btn am-btn-default am-btn-success" ><span class="am-icon-plus"></span>新增</button>
                                ...
                                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                        <input type="text" class="am-form-field " name="pdmname" id="pdmname">
                                        <span class="am-input-group-btn">
                                            <button type="submit" id="searchdeploy" class="am-btn  am-btn-default am-btn-success tpl-table-list-field am-icon-search" onclick="searchdeploy()"></button>
                                        </span>
                                    </div>
                                </div>
